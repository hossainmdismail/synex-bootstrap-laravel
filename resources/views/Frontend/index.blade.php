...
@section('content')
        ...
        <div class="container py-md-5">
            <div class="row py-4 d-flex align-items-center">
                <div class="col-md-6 order-2 order-md-1">
                    ...
                    <h2 class="font-description pt-4">
    ...
    <section class="container-fluid">
        <div class="container py-5">
            <div class="row  text-center mb-4">
                ...
                <h3 class="section-title font-second">Projects We Developed</h3>
            </div>
    ...
    <!-- Testimonials -->
    <section id="testimonial" class="container-fluid bg-testimonial">
        <div class="py-5">
            <div class="container">
                <div class="row mb-4 text-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="pt-3">
                                            <div class="d-flex gap-3 mb-1 justify-content-between">
                                                ...
                                                <!-- Comments -->
                                                <div class="d-flex gap-1 align-items-center">
                                                    {{ $blogs['popular']['view'] }}<p class="card-nap">View</p>
                                                </div>
                                            </div>
