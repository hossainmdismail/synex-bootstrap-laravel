<div class="calendly-box">
    <span class="d-flex justify-content-end align-items-center p-4 position-absolute end-0" id="calendly-close"
    ...
    {{-- <div class="calendly-inline-widget" data-url="https://calendly.com/synexdigital?hide_gdpr_banner=1"
