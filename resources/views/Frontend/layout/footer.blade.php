                            ...
                            <ul class="footer-ul">
                                ...
                                <li class="footer-ul-item pt-2">
                                    ...
                                    <a class="text-decoration-none 	 me-2" href="#">
                                        <svg class="footer-social-icon" width="31" height="30"
                                        ...
                                        <svg class="footer-social-icon" width="31" height="30"
                                            ...
                                            <g clip-path="url(#clip0_550_215)">
                                                <path
                                                    ...
                                                    fill="#0078B5" />
                                                <path
                                                    d="M7.86834 15.4923H13.1843V32.6003H7.86834V15.4923ZM10.5283 6.98828C12.2283 6.98828 13.6083 8.36828 13.6083 10.0723C13.6083 11.7763 12.2283 13.1563 10.5283 13.1563C8.82434 13.1563 7.44434 11.7763 7.44434 10.0723C7.44034 8.37228 8.82034 6.98828 10.5283 6.98828Z"
                                                    fill="white" />
                                                <path
                                                    d="M16.5203 15.4925H21.6203V17.8285H21.6923C22.4003 16.4845 24.1323 15.0645 26.7243 15.0645C32.1083 15.0645 33.1043 18.6085 33.1043 23.2125V32.6005H27.7883V24.2845C27.7883 22.2965 27.7523 19.7485 25.0243 19.7485C22.2563 19.7485 21.8323 21.9085 21.8323 24.1405V32.6045H16.5203V15.4925Z"
                                                    fill="white" />
                                            </g>
                                            <defs>
                                    ...
                                    <a class=" text-decoration-none	  me-2 " href="">
                                        <svg width="41" class="footer-social-icon"="31" height="30"
                                            viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M3.91293 5L16.5691 21.9225L3.83301 35.6812H6.69939L17.8498 23.6353L26.8591 35.6812H36.6135L23.2452 17.8069L35.0999 5H32.2335L21.9645 16.0941L13.6674 5H3.91293ZM8.12816 7.11138H12.6094L32.3976 33.5695H27.9164L8.12816 7.11138Z"
                                                fill="black" />
                                        </svg>
