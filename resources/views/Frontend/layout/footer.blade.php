        ...
        <div class="container">
            ...
            <div class="row align-items-end mb-6 sm-mb-40px">
                ...
                <div class="col-lg-3 col-sm-4 text-center text-sm-start xs-mb-25px last-paragraph-no-margin">
                    <span class="d-block text-dark-gray ls-minus-05px mb-5px fw-600">Synex Digital - Canada</span>
                    <p class="w-80 lg-w-100 text-medium-gray fs-15 lh-28"> 379 Lawthorn Way SE, AB, Canada</p>
                </div>
                <!-- end footer column -->
                <!-- start footer column -->
                <div class="col-lg-3 col-sm-4 text-center text-sm-start xs-mb-25px last-paragraph-no-margin">
                    <span class="d-block text-dark-gray ls-minus-05px mb-5px fw-600">Synex Digital - Bangladesh</span>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 text-center text-lg-end">
                        <span class="fs-15">&copy; 2024 Synex Digital</span>
                    </div>
                </div>
            </div>
        </div>
