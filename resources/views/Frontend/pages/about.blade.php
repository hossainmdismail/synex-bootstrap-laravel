                ...
                <div class="col-lg-5 md-mb-10px"
                    ...
                    <div class="icon-with-text-style-08 mb-25px">
                        <div class="feature-box feature-box-left-icon-middle">
                            <div
                                class="feature-box-icon feature-box-icon-rounded w-50px h-50px rounded-circle bg-base-color text-dark-gray me-15px">
                                ★
                            </div>
                ...
                <div class="col-lg-7"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 last-paragraph-no-margin">
                            <p>At Synex Digital, we go beyond being a digital solutions provider. We are your trusted
                                partner in driving technology and business growth. With over 8 years of experience, we
                                specialize in delivering innovative Web and App development, Custom Software Solutions, and
                                comprehensive Digital Marketing services tailored to your business needs.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 last-paragraph-no-margin">
                            <p>We’re dedicated to helping businesses thrive in the digital landscape by providing
                                high-quality, scalable solutions that enhance user experience, boost online visibility, and
                                drive engagement. Partner with us to transform your vision into reality and stay ahead in
                                the competitive marke.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 md-mb-30px"
                    ...
                    <p class="w-90 md-w-100">We are excited for our work and how it positively impacts clients. With over 8
                    ...
                    <div class="row row-cols-auto row-cols-sm-2"
                        ...
                        <div class="col align-self-start">
                            <div class="feature-box text-start ps-30px">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin pt-25 md-pt-17 sm-pt-40px">
                                    <span class="text-dark-gray fs-19 d-inline-block fw-600 mb-5px">Experience and
                                        Expertise</span>
                                    <p>With years of experience and specialized skills, Synex Digital delivers top-notch
                                        solutions and innovative strategies to drive your business forward.</p>
                        ...
                        <div class="col align-self-end mt-20 xs-mt-15px">
                            <div class="feature-box text-start ps-30px">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin pt-25 md-pt-17 sm-pt-40px">
                                    <span class="text-dark-gray fs-19 d-inline-block fw-600 mb-5px">Customized
                                        Solutions</span>
                                    <p>We craft tailored solutions to meet your unique needs, ensuring personalized
                                        strategies and exceptional results that align perfectly with your business goals.
                                    </p>
                                    <span class="w-40px h-3px bg-base-color d-inline-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="col align-self-start mt-minus-12 xs-mt-15px">
                            <div class="feature-box text-start ps-30px">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin pt-25 md-pt-17 sm-pt-40px">
                                    <span class="text-dark-gray fs-19 d-inline-block fw-600 mb-5px">Trust and
                                        Reliability</span>
                                    <p>Count on us for dependable, trustworthy service. Our commitment to integrity and
                                        consistent performance ensures you can rely on us for all your digital needs.</p>
                                    <span class="w-40px h-3px bg-base-color d-inline-block"></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row mb-6 sm-mb-40px"
                ...
                <div class="col-lg-5 offset-lg-1">
                    <p class="w-95 md-w-100">Our expert team transforms your vision into reality. With skilled developers
                        and creative designers, we bring passion and experience to every project. Discover the talent
                        driving our success and how they contribute to your growth.</p>
                    <a class="btn btn-medium btn-expand-ltr text-dark-gray btn-rounded fw-700"><span
            ...
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 transition-inner-all mb-6 lg-mb-5"
                ...
                @foreach ($member as $person)
                    <div class="{{ $person['class'] }}" data-bottom-top="transform: translateY(40px)"
                        ...
                        <figure style="background:#e5e5e5 !important"
                            ...
                            <figcaption
                                ...
                                <div class="w-100">
                                    <span
                                        class="team-member-name fw-500 alt-font text-white d-block">{{ $person['name'] }}</span>
                                    <span
                                        class="member-designation fs-15 lh-20 text-white d-block">{{ $person['path'] }}</span>
                                </div>
            ...
            <div class="row mb-2">
                <div class="col-12 text-center">
                    <div class="text-dark-gray fs-20 ls-minus-05px">Our nearly <span class="fw-700">50+</span> creative
                        team members are ready to help now. <a href="{{ route('contact') }}"
