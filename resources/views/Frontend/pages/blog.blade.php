            ...
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen sm-h-auto">
                    <div class="col-lg-10 text-center">
                        <span class="fs-18 mb-30px d-inline-block sm-mb-20px">By <a href="demo-web-agency-blog.html" class="text-dark-gray text-dark-gray-hover text-decoration-line-bottom">{{$content['author']}}</a> in <a href="demo-web-agency-blog.html" class="text-dark-gray text-dark-gray-hover text-decoration-line-bottom">{{$content['category']}}</a> on {{$content['date']}}</span>
        ...
        <section class="py-0 ps-13 pe-13 lg-ps-4 lg-pe-4 sm-px-0">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12"><img class="w-100" alt="" data-cfsrc="{{$content['image']}}" style="display:none;visibility:hidden;"><noscript><img src="{{$content['image']}}" class="w-100" alt=""></noscript></div>
                </div>
            </div>
        </section>
        <!-- end section -->
                    ...
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="col-lg-3 col-md-4 text-center sm-mb-30px">
                                <div class="pb-20px">
                                    <img class="rounded-circle w-130px mb-20px" alt="" data-cfsrc="images/blog-single-creative-avtar.jpg" style="display:none;visibility:hidden;"><noscript><img src="images/blog-single-creative-avtar.jpg" class="rounded-circle w-130px mb-20px" alt=""></noscript>
                                    <span class="d-block lh-22">Words by</span>
                                    <a href="demo-web-agency-blog.html" class="text-dark-gray text-dark-gray-hover alt-font fw-500 text-uppercase">{{$content['author']}}</a>
                                </div>
                                <div class="h-3px w-100 bg-dark-gray mb-20px"></div>
                                <ul class="d-flex list-unstyled justify-content-center">
                                    <li class="me-25px"><a href="#" class="text-dark-gray-hover text-uppercase alt-font fs-13">👁 {{$content['view']}}</a></li>
                                    <li><a href="#" class="text-dark-gray-hover text-uppercase alt-font fs-13">♡ Like</a></li>
                                </ul>
                            </div>
                                ...
                                <li class="grid-item design marketing">
                                    <div class="card bg-transparent border-0 h-100">
                                        ...
                                        <div class="card-body px-0 pt-30px pb-30px xs-pb-15px">
                                            <span class="fs-14 text-uppercase d-block mb-5px fw-500"><a href="{{route('blog.view', $blog['slug'])}}" class="text-dark-gray text-dark-gray-hover fw-700 categories-text">{{$blog['category']}}</a><a href="#" class="blog-date text-medium-gray-hover">{{$blog['date']}}</a></span>
