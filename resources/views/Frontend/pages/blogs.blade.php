...
@section('content')
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-lg-6 p-4">
                <a href="blog-details.html" class="text-decoration-none">
                    <div class="card border-0 bg-light">
                        <img src="{{ asset('Frontend/images/cta-image.jpg') }}" class="card-img-top rounded"
                            alt="Featured Image">
                    </div>
                </a>
            </div>
            <div class="col-lg-6 p-md-4 px-4 px-md-0">
                <a href="#" class="text-decoration-none">
                    <h3 class="card-title text-dark py-md-4 pb-0 pb-md-2" style="font-size: 22px !important">Lorem Ipsum Is
                        a Dummy Text sed
                        diam
                ...
                <p class="card-text mt-3">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                    euismod
                    tincidunt ut laoreet dolore magna aliquam. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex,
                    perspiciatis necessitatibus. Atque, aperiam velit ex adipisci sed unde culpa debitis repellendus rerum,
                    quasi maxime veritatis ad nam vitae obcaecati temporibus nisi dolorem qui! Maxime accusantium at sed
                    sapiente adipisci incidunt!</p>
                <div class="d-flex justify-content-between py-2">
                    <div class="card-pan">Esmail • 7 Jan 2023</div>
        ...
        <div class="row">
            @foreach ($blogHero as $blog)
                <div class="col-md-4 mb-4">
                    <x-blog title="{{ $blog['title'] }}" category="{{ $blog['category'] }}" date="{{ $blog['date'] }}"
    ...
    <div class="container my-5">
        ...
        <div class="text-center mt-4">
            <button class="btn btn-primary rounded-pill">Load More Blogs</button>
        </div>
    </div>
