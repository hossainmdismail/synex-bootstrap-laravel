...
@section('content')
    ...
    <section id="privacy-policy" class="container my-5">
        <h1 class="section-title text-center pb-5"><span class="section-title1"> Privacy Policy</span></h1>
        <p>At Synex Digital, accessible from <a href="https://www.synexdigital.com">www.synexdigital.com</a>, one of our main
            priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is
            collected and recorded by Synex Digital and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
            to the information that they shared and/or collect in Synex Digital. This policy is not applicable to any
            information collected offline or via channels other than this website.</p>

        <h2><span class="section-title1"> Information </span> we collect</h2>
        ...
        <h3>How we use your <span class="section-title1"> Information </span></h3>
        ...
        <h2><span class="section-title1"> Advertising Partners </span> Privacy Policies</h3>
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Synex Digital.
            </p>
            <p>Third-party ad servers or ad networks uses technologies like cookies. JavaScript, or Web Beacons that are
                used in
                their respective advertisements and links that appear on Synex Digital, which are sent directly to users'
            ...
            <p>Note that Synex Digital has no access to or control over these cookies that are used by third-party
                advertisers.
            </p>
    </section>
