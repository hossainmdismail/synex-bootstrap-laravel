            ...
            <div class="row py-3 py-md-5">
                <div class="col-md-6 px-4 px-md-2 position-relative">
                    <div class="bd-top">
                        ...
                        <p class="pt-2">
                            Whether you're starting from square one or transitioning to a software-as-a-service model, our SaaS application development company brings decades of hands-on experience developing bespoke SaaS solutions end-to-end and sustaining them through our dedicated team approach.
                        </p>
                        <div class="pt-4">
    ...
    <section class="container py-5">
        <div class="row pb-4">
            <div class="col-md-6 m-auto text-center">
                <h3>Empower your business with our  <span class="text-primary">SaaS application</span> development services</h3>
                <p class="pt-3">
                    Software-as-a-service is the way to go in today's tech world. At Synex Digital, we make your Software as a Service development smoother, less risky, and more predictable. We’re the team to help you build a great product that powers a scalable software business.
                </p>
            </div>
        </div>
