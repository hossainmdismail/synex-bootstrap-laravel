    ...
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-md-6 m-auto text-center">
                <a href="{{ route('contact') }}" class="btn-default btn btn-white collaborate-btn mb-3">Contact Us
                    <svg class="ms-3" width="15" height="14" viewBox="0 0 16 15" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.5 14L14.5 1M14.5 1L14.5 13.48M14.5 1L2.02 1" class="icon-path" stroke="#60A5FA"
